...
def hb(x_0, x_star, f_star, A, b, A_0, b_0, stepsize, eta, eps,la, n_workers, experiment_name, project_path, dataset, Nsteps=100000):
    dim = x_0.shape[0]
...
experiment_name = "pl-hb_nw-{0}_{1}x_e-{2}".format(n_w, myrepr(factor), myrepr(eta))
begin_time = datetime.datetime.now()
results = hb(x_0, x_star, f_star, X, y, X_0, y_0, step_size_hb, eta, eps, la, n_w, experiment_name, project_path, dataset, Nsteps=nsteps)
